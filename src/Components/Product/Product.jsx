                ...
                <div className="previewImgContainer">
                  ...
                  >
                    <PhotoView key={index} src={item}>
                      <img src={item} alt="" className="previewImg cursor-pointer" />
                    </PhotoView>
                  </PhotoProvider>
                </div>
              );
        ...
        <div className="media">
          ...
          <div className="btns">
            ...
            <Button
              ...
              onClick={handleBuy}
            >
              <FlashOnIcon sx={{ marginRight: 1, marginLeft: 0 }} />
              BUY NOW{" "}
            </Button>
          </div>
        </div>
          ...
          <div className="offer">
            ...
            <ul>
              ...
              <li>
                <LocalOfferIcon color="success" sx={{ marginRight: 1 }} />
                <b>Bank offer </b>
                10% cashback on Flipkart Credit Card upto ₹4,000 per calendar
                quarter <span className="tc">T&C</span>
              </li>
              <li>
                <LocalOfferIcon color="success" sx={{ marginRight: 1 }} />
                <b>Bank offer </b>
                7% cashback on HDFC Bank Flipkart Debit Card up to ₹1000{" "}
                <span className="tc">T&C</span>
              </li>
            </ul>
          </div>
